package com.urbanlife.lifeurban.ui.custom;
...
public class MagicTextView extends AppCompatTextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.MagicTextView_backgroundMTV)){
				Drawable background = a.getDrawable(R.styleable.MagicTextView_backgroundMTV);
				if(background != null){
					this.setBackgroundDrawable(background);
				}else{
					this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_backgroundMTV, 0xff000000));
				}
			}
