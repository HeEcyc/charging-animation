...
class Prefs(private var sharedPreferences: SharedPreferences) {
    ...
    companion object {
        ...
        private const val CHAIN_INDEX = "mmcxd_chain_index"
    ...
    fun getChainIndex() = sharedPreferences.getInt(CHAIN_INDEX, 0)

    fun saveChainIndex(index: Int) {
        editor.putInt(CHAIN_INDEX, index).apply()
    }
